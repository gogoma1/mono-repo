...
// server/node_modules/hono/dist/client/utils.js
var mergePath2 = /* @__PURE__ */ __name((base, path) => {
  base = base.replace(/\/+$/, "");
  base = base + "/";
  path = path.replace(/^\/+/, "");
  return base + path;
...
var removeIndexString = /* @__PURE__ */ __name((urlSting) => {
...
// server/node_modules/hono/dist/client/client.js
...
var hc = /* @__PURE__ */ __name((baseUrl, options) => createProxy(/* @__PURE__ */ __name(function proxyCallback(opts) {
  ...
  const url = mergePath2(baseUrl, path);
  if (method === "url") {
    let result = url;
    if (opts.args[0]) {
...
var client = hc("");
var hcWithType = /* @__PURE__ */ __name((...args) => hc(...args), "hcWithType");
...
// .wrangler/tmp/bundle-yFlmgR/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-yFlmgR/middleware-loader.entry.ts
