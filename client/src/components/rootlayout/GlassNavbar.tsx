...
import { useUIStore } from '../../stores/uiStore'; // 경로 확인
import { LuLayoutDashboard, LuMenu, LuSettings2, LuUser } from 'react-icons/lu';
import Tippy from '@tippyjs/react'

// Popover 및 내부 콘텐츠 컴포넌트 임포트
import GlassPopover from '../common/popover/GlassPopover'; // 경로 확인
import ProfileMenuContent from '../common/popover/MenuContent/ProfileMenuContent'; // 알려주신 경로로 수정
